...
public class TestRunner {
    ...
    public static HashMap<String, String> testMethod(HashMap<String, String[]> parameters) {
        HashMap<String, String> result = new HashMap<>();

        //NAME OF THE METHOD TO INVOKE
        String[] methodName = parameters.get(String.valueOf(Param.methodName));
        ...
        if (methodName != null) {
            ...
            // CHECK OUTPUT
            String[] checkOutM = parameters.get(String.valueOf(Param.checkSysOut));
            boolean checkOut;
            if (checkOutM == null) {
                checkOut = false;
            } else {
        ...
        // CHECK REFLECTION
        String[] reflectionList = parameters.get(String.valueOf(Param.reflect));
